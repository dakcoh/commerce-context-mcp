...
public class SpringCommerceContextTool {
    ...
    @Tool(name = "get_spring_commerce_implementation_context",
          description = """
                  ...
                  모듈형 모놀리스, 트랜잭션, JPA, 동시성, API 오류, Outbox, Redis, 배치, 테스트와 관측성을 포함합니다.
    ...
    @Tool(name = "search_spring_commerce_knowledge",
          description = """
                  ...
                  Transactional, JPA, Redis, Outbox, Scheduler, Testcontainers 등 Spring 구현 질문에 사용하세요.
                  """)
    public String searchSpringCommerceKnowledge(
            @ToolParam(description = "검색 키워드 (예: '@Transactional', 'JPA', 'Redis', 'Outbox', 'Testcontainers')") String keyword) {
